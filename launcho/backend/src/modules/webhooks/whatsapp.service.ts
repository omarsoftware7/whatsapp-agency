...
export class WhatsappService {
  ...
  async downloadWhatsappMedia(mediaId: string, jobId: number | string, subdirHint: 'products' | 'logos' | 'generated' = 'products'): Promise<string | null> {
    ...
    try {
      ...
      const filename = `product_${Date.now()}_${mediaId}.${ext}`;
